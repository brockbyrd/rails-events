...
Event.create(performer: "The Weeknd", price: "50", time: DateTime.new(2021,1,15,7), arena_id: "1", user_id: "1")
Event.create(performer: "The Cubs", price: "25", time: DateTime.new(2021,7,30,12,30), arena_id: "2", user_id: "2")
Event.create(performer: "Guns N' Roses", price: "75", time: DateTime.new(2021,8,3,6), arena_id: "3", user_id: "3")
Event.create(performer: "Dave Chapelle", price: "45", time: DateTime.new(2021,9,7,8), arena_id: "4", user_id: "4")
Event.create(performer: "Drake", price: "100", time: DateTime.new(2021,7,8,9), arena_id: "5", user_id: "5")
Event.create(performer: "Bill Burr", price: "35", time: DateTime.new(2021,11,3,4), arena_id: "6", user_id: "1")
Event.create(performer: "Louisville Basketball", price: "15", time: DateTime.new(2020,12,14,11), arena_id: "7", user_id: "2")
Event.create(performer: "Clippers and Lakers", price: "30", time: DateTime.new(2020,12,25,7), arena_id: "8", user_id: "3")
Event.create(performer: "Future", price: "60", time: DateTime.new(2021,4,19,9), arena_id: "9", user_id: "4")
Event.create(performer: "New York Jets", price: "15", time: DateTime.new(2020,12,6,12), arena_id: "10", user_id: "5")
